...
const SignIn = ({ action }: SignUpProps) => {
  const [state, formAction, isPending] = useActionState(action, initilState);
      ...
      <div className=" space-y-6">
        ...
        <div className=" space-y-2">
          ...
          <input
            ...
            autoComplete="email"
            required
            className="w-full px-4 py-3 border border-gray-200 rounded-md  focus:ring-black focus:border-transparent transition-colors"
        ...
        <div className="text-center">
          ...
          <p className="text-xs text-gray-500 mb-4">
            🛍️ Plug get free shipping on orders over $15.0
          </p>
        </div>
        {/* Submit */}
        <button
