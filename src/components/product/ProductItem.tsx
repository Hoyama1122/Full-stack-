...
const ProductItem = ({ product }: ProductItemProps) => {
  return (
    <div className="bg-white rounded-lg overflow-hidden relative">
      ...
      <div className="p-4">
        <h3 className="text-sm font-medium line-clamp-2 h-12 mb-1">
          {product.title}
        </h3>
        <div className="flex flex-col">
          ...
          <Link href={`/product/${product._id}`} className=" w-full text-center bg-gradient-to-r from-red-500 to-orange-500 text-white py-2 rounded-full text-sm font-bold hover:brightness-110 transition-all">GRAB IT NOW!</Link>
